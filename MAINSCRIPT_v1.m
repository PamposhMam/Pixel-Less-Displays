...
% Replay = ifft2(Holo_mod); % FFT of binary phase modulated hologram% Step 4: Compute the Replay Field
% Replay = ifft2(Holo_mod); % FFT of binary phase modulated hologram% Step 4: Compute the Replay Field
% Replay = ifft2(Holo_mod); % FFT of binary phase modulated hologram
...
save(fullfile(outputFolder, [name '_Holo_.mat']), 'Holo')
%%
